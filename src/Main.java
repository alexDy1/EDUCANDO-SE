...
public class Main {
    public static void main(String[] args) {
        ...
        Jefe mateo= new Jefe(55,61666,6416464,"Mateo","Calle Uruguay");
        DirectorFinanciero joerge = new DirectorFinanciero(466,84564,46464,"Joerge","Av.San Martin");
        Empleado marco= new Empleado(644,84848,66464,"Marco","Av. 25 de Mayo");
